/*
 *-------------------
 * The ASHDatabasePG90.java is part of ASH Viewer
 *-------------------
 *
 ...
 */
public class ASHDatabasePG90 extends ASHDatabase {
    ...
    private String queryASH = "SELECT current_timestamp as current_timestamp, datid, datname, procpid as pid, usesysid, "
		...
		+ "CASE WHEN xact_start is not NULL THEN 'active' ELSE 'idle' END as state "
		+ "from pg_stat_activity "
		+ "where (CASE WHEN xact_start is not NULL THEN 'active' ELSE 'idle' END)='active' and procpid != pg_backend_pid() ";
     ...
     */
    public ASHDatabasePG90(Model model0) {
        super(model0);
        this.model = model0;
    ...
    private void loadAshDataToLocal() {
		...
		// set Timeout to 1 second
		    ...
		    String backendType = "";
                    ...
                    Boolean waiting = resultSetAsh.getBoolean("waiting");
                    String event = "";
                    String waitClass = "";
